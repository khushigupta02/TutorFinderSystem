				...
				<li style="float: right;">
					<div class="testbox" >
						<form action="" method="POST" class="registration">
								...
								<div style="text-align: center;font-size: 20px;color: #aaa;margin: 0 0 5px 0;" class="py-3">
								...
								<div style="text-align: center;font-size: 20px;color: #aaa;margin: 0 0 5px 0;" class="py-2 mt-3">
									<td >Change Email:</td>
								</div>
								<div>
