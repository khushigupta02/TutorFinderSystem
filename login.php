...
<div>
				...
				<table>
					<tr>
						<?php
							if($user != ""){
								echo '<td>
							<a class="active navlink" href="#profile?uid='.$user.'">'.$uname_db.'</a>
						</td>
						<td>
	...
	<div class="nbody py-3" style="margin: 0px 100px; overflow: hidden;">
		<div class="nfeedleft " style="background-color: unset;">
			<div>
		<div class="testbox py-5" style="height: 400px;">
  <h1>Login</h1>
  ...
  <div>
  <div style="float: right; width: 35%; margin-top: 10px;" class="py-2">
  ...
  <div style="width: 50%; float: left; padding: 10px 0 5px 4px">
  	<p>Forget your password?<a href="#" style="font-weight: bold; text-decoration:none;"> Click here</a>.</p>
  <p>Not registered yet?<a href="registration.php" style="font-weight: bold; text-decoration:none;"> Register here</a>.</p>
  </div>
  </div>
  </form>
</div>
