...
class checkboxlist{
	public function sublist()
	{
		echo'
			...
			<div class="divp35"><input type="checkbox" name="sub_list[]" value="Sanskrit"><span>Sanskrit</span></div>
			<div class="divp35"><input type="checkbox" name="sub_list[]" value="General Knowledge"><span>General Knowledge</span></div>
